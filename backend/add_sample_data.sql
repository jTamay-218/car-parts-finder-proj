...
('honda-id', 'Honda', 'cf6cc49b-b8e6-456e-a253-e97558104e72', datetime('now')),
('toyota-id', 'Toyota', 'cf6cc49b-b8e6-456e-a253-e97558104e72', datetime('now')),
('ford-id', 'Ford', 'cf6cc49b-b8e6-456e-a253-e97558104e72', datetime('now')),
('chevrolet-id', 'Chevrolet', 'cf6cc49b-b8e6-456e-a253-e97558104e72', datetime('now')),
('nissan-id', 'Nissan', 'cf6cc49b-b8e6-456e-a253-e97558104e72', datetime('now')),
('audi-id', 'Audi', 'cf6cc49b-b8e6-456e-a253-e97558104e72', datetime('now')),
('volkswagen-id', 'Volkswagen', 'cf6cc49b-b8e6-456e-a253-e97558104e72', datetime('now')),
('lexus-id', 'Lexus', 'cf6cc49b-b8e6-456e-a253-e97558104e72', datetime('now'));

-- Add more car models
INSERT INTO car_models (_id, name, car_brand_id, production_year, created_date) VALUES 
-- Honda models
('civic-2020', 'Civic', 'honda-id', 2020, datetime('now')),
('civic-2021', 'Civic', 'honda-id', 2021, datetime('now')),
('accord-2020', 'Accord', 'honda-id', 2020, datetime('now')),
('accord-2021', 'Accord', 'honda-id', 2021, datetime('now')),
('cr-v-2020', 'CR-V', 'honda-id', 2020, datetime('now')),
-- Toyota models
('camry-2020', 'Camry', 'toyota-id', 2020, datetime('now')),
('camry-2021', 'Camry', 'toyota-id', 2021, datetime('now')),
('corolla-2020', 'Corolla', 'toyota-id', 2020, datetime('now')),
('corolla-2021', 'Corolla', 'toyota-id', 2021, datetime('now')),
('rav4-2020', 'RAV4', 'toyota-id', 2020, datetime('now')),
-- Ford models
('f150-2020', 'F-150', 'ford-id', 2020, datetime('now')),
('f150-2021', 'F-150', 'ford-id', 2021, datetime('now')),
('mustang-2020', 'Mustang', 'ford-id', 2020, datetime('now')),
('escape-2020', 'Escape', 'ford-id', 2020, datetime('now')),
-- Chevrolet models
('silverado-2020', 'Silverado', 'chevrolet-id', 2020, datetime('now')),
('silverado-2021', 'Silverado', 'chevrolet-id', 2021, datetime('now')),
('malibu-2020', 'Malibu', 'chevrolet-id', 2020, datetime('now')),
('equinox-2020', 'Equinox', 'chevrolet-id', 2020, datetime('now')),
-- BMW models
('3series-2020', '3 Series', 'b41e288a-3dd0-4a7e-b420-21633a43b74d', 2020, datetime('now')),
('3series-2021', '3 Series', 'b41e288a-3dd0-4a7e-b420-21633a43b74d', 2021, datetime('now')),
('x5-2020', 'X5', 'b41e288a-3dd0-4a7e-b420-21633a43b74d', 2020, datetime('now')),
('x3-2020', 'X3', 'b41e288a-3dd0-4a7e-b420-21633a43b74d', 2020, datetime('now')),
-- Audi models
('a4-2020', 'A4', 'audi-id', 2020, datetime('now')),
('a4-2021', 'A4', 'audi-id', 2021, datetime('now')),
('q5-2020', 'Q5', 'audi-id', 2020, datetime('now')),
('q7-2020', 'Q7', 'audi-id', 2020, datetime('now'));

-- Add more categories
INSERT INTO categories (_id, name, image, created_date) VALUES 
('brake-pads', 'Brake Pads', NULL, datetime('now')),
('brake-rotors', 'Brake Rotors', NULL, datetime('now')),
('alternator', 'Alternator', NULL, datetime('now')),
('battery', 'Car Battery', NULL, datetime('now')),
('headlights', 'Headlights', NULL, datetime('now')),
('taillights', 'Tail Lights', NULL, datetime('now')),
('mirrors', 'Side Mirrors', NULL, datetime('now')),
('windshield', 'Windshield', NULL, datetime('now')),
('radiator', 'Radiator', NULL, datetime('now')),
('spark-plugs', 'Spark Plugs', NULL, datetime('now')),
('oil-filter', 'Oil Filter', NULL, datetime('now')),
('air-filter', 'Air Filter', NULL, datetime('now')),
('transmission', 'Transmission Parts', NULL, datetime('now')),
('suspension', 'Suspension', NULL, datetime('now')),
('exhaust', 'Exhaust System', NULL, datetime('now'));
